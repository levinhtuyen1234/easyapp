...
(function (factory) {
    ...
    var dialog = renderer.create('<div class="bootstrap-iso modal" data-backdrop="static" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
        if (options.fade) {
            $node.addClass('fade');
        }
        $node.html([
