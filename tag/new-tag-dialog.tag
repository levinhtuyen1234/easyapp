<new-tag-dialog class="modal fade" tabindex="-1" role="dialog" data-backdrop="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" class="form-control" id="tagFilenameElm" placeholder="FileName" disabled value="{tagFileName}">
    ...
    <script>
        ...
        me.add = function () {
            riot.api.trigger('addTag', me.tagName, me.tagFileName + '.json');
        };

        me.updateTagName = function (e) {
            me.tagName = e.target.value.trim();
            var combining = /[\u0300-\u036F]/g;
            me.tagFileName = me.tagName.normalize('NFKD').replace(combining, '').replace(/\s/g, '-').toLowerCase().trim();
            me.update();
        };
