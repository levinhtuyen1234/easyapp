      ...
      <div class="container-responsive">
        <div class="columns">
          <div class="one-third column">
            <h3 class="display-heading-3" style="line-height: 1.2;">Introducing unlimited <br class="d-none-sm-dn">private&nbsp;websites</h3>
          </div>
          <div class="two-thirds column">
            <p class="mt-2 mb-0">All of our paid plans on EasyWebHub.com now include unlimited private websites. <a href="/join">Sign&nbsp;up</a>&nbsp;to get started or <a href="https://github.com/blog/2164-introducing-unlimited-private-repositories">read more about this change on our blog</a>.</p>
