...
function paginate(files, metalsmith, done) {
    ...
    var complete = Object.keys(metadata.tag).every(function (name) {
        var collection;
        ...
        toShow.forEach(function (file, index) {
            ...
            if (!pageMap.hasOwnProperty(name)) {
                ...
                var pagination = {
                    name: name,
                    tag: tagName,
                    tagDisplayName: pageOptions.displayName,
                    index: length,
                    num: length + 1,
                    pages: pages,
                    files: [],
...
module.exports = function (opts) {
    ...
    var tagFilePrefix = 'tag' + path.sep;
    return function (files, metalsmith, done) {
        var metadata = metalsmith.metadata();
        var tag = {};
        metadata.tag = tag;
        metadata.tagOption = tagOption;
