    ...
    return function (files, metalsmith, done) {
        ...
        for (var key in categoryFlatMap) {
            ...
            for (var settingKey in settings) {
                ...
                if (settingKey === 'childs') continue;
                if (settingKey === 'displayName') {
                    categoryFlatMap[key]['categoryDisplayName'] = settings[settingKey];
                } else {
            ...
            categoryFlatMap[key].href = interpolate(settings.first, categoryFlatMap[key]);
        ...
        categoryKeys.forEach(function (key) {
            ...
            if (chunks.length == 1) {
                ...
                chunks.forEach(function (chunkName) {
                    ...
                    parentNode.childs.some(function (node) {
                ...
                category.childs = [];
                category.parent = rootTree;
                parentNode.childs.push(category);
            }
        });
