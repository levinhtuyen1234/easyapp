...
function paginate(files, metalsmith, done, categoryOption) {
    ...
    var complete = Object.keys(metadata.categoryData).every(function (name) {
        var collection;
        ...
        //} catch (error) { }
        collection = metadata.categoryData[name];
...
module.exports = function (opts) {
    return function (files, metalsmith, done) {
        ...
        metadata.categoryData = category;
